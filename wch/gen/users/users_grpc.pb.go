...
const (
	...
	UsersService_GetUsersByIDs_FullMethodName  = "/users.v1.UsersService/GetUsersByIDs"
...
func (c *usersServiceClient) GetUsersByIDs(ctx context.Context, in *GetUsersByIDsRequest, opts ...grpc.CallOption) (*ListUsersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUsersServiceServer) GetUsersByIDs(context.Context, *GetUsersByIDsRequest) (*ListUsersResponse, error) {
