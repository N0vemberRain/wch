...
const (
	MessagesService_SendMessage_FullMethodName  = "/msgs.v1.MessagesService/SendMessage"
	MessagesService_ListMessages_FullMethodName = "/msgs.v1.MessagesService/ListMessages"
)
...
func (c *messagesServiceClient) SendMessage(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*MessageResponse, error) {
...
func (UnimplementedMessagesServiceServer) SendMessage(context.Context, *SendMessageRequest) (*MessageResponse, error) {
...
var MessagesService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "msgs.v1.MessagesService",
